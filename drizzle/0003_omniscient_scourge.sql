ALTER TABLE "chats" ADD COLUMN "user_id" varchar;--> statement-breakpoint
ALTER TABLE "documents" ADD COLUMN "user_id" varchar;--> statement-breakpoint
ALTER TABLE "prompts" ADD COLUMN "user_id" varchar;--> statement-breakpoint
ALTER TABLE "settings" ADD COLUMN "user_id" varchar;--> statement-breakpoint
